...
export const HomePage: React.FC<HomePageProps> = ({ onOpenScheduler }) => {
  ...
  return (
    <div className="bg-[#f6f3ef] text-[#28302f]">
      <section className="relative overflow-hidden bg-[#41342e] text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-4 pb-16 pt-14 sm:px-6 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:pb-24 lg:pt-20">
          <div className="max-w-3xl self-center">
            ...
            <h1 className="apex-hero-enter apex-hero-enter-delay-1 max-w-2xl font-serif-display text-2xl font-bold leading-[1.05] text-white sm:text-3xl lg:text-4xl"><span className="text-[#f4d994]">Protecting what matters most:</span> your family, your future, your peace of mind.</h1>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <button onClick={onOpenScheduler} className="gold-cta apex-cta inline-flex items-center justify-center gap-2 bg-[#d6a84d] px-6 py-3.5 text-sm font-bold text-[#41342e] transition hover:bg-[#b88a2d] hover:text-[#fffaf5]">Free Case Evaluation <ArrowRight className="h-4 w-4" /></button>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8" id="practice-areas">
        <div className="grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          <div className="max-w-3xl">
            <p className="text-xs font-bold uppercase tracking-[.22em] text-[#a87920]">Focused family-law counsel</p>
            <h2 className="mt-4 text-4xl font-bold leading-[0.98] tracking-[-0.04em] text-[#173b3b] sm:text-5xl lg:text-[4rem]">The right depth for the moment you are in.</h2>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">Family law is personal. Our practice is deliberately focused so your advice is specific, strategic, and grounded in the life you are trying to protect.</p>
          </div>
          <div className="apex-media-card apex-float overflow-hidden rounded-[1.25rem] border border-[#d9d5ce] bg-white shadow-[0_18px_40px_rgba(65,52,46,0.08)]">
            <img src={images} alt="Family counseling session" className="h-[260px] w-full object-cover object-center sm:h-[320px]" />
          </div>
        </div>
      ...
      <section className="bg-[#d6a84d]" id="contact"><div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:px-8"><div className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[.22em] text-[#173b3b]">Apex Family Law</p><h2 className="mt-4 text-4xl font-bold leading-[0.98] tracking-[-0.04em] text-[#173b3b] sm:text-5xl">A steady voice for your next decision.</h2><p className="mt-5 max-w-2xl text-lg leading-8 text-[#365451]">Call our confidential 24/7 answering service or request a free case evaluation. Attorney advertising. Prior results do not guarantee a similar outcome.</p><div className="mt-8 flex flex-wrap items-center gap-x-8 gap-y-3 text-lg font-bold text-[#173b3b]"><span className="inline-flex items-center gap-2"><Phone className="h-5 w-5" />(800) 555-FAMILY</span><span className="inline-flex items-center gap-2"><MapPin className="h-5 w-5" />San Francisco | Palo Alto</span></div></div><div className="apex-media-card apex-float overflow-hidden rounded-[1.25rem] border border-[#173b3b]/20 bg-white shadow-[0_18px_40px_rgba(65,52,46,0.12)]"><img src="https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=1200&q=80" alt="Family law office" className="h-[260px] w-full object-cover object-center sm:h-[300px]" /></div></div></section>
    </div>
  );
};
